...
CREATE TABLE `claim_notes` (
  ...
  `Notes_creation_date` date DEFAULT NULL,
  `Notes_updation_date` date DEFAULT NULL,
  `Subject` varchar(45) DEFAULT NULL,
  `Notes_content` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`Claim_id`),
  CONSTRAINT `notes_claim_id` FOREIGN KEY (`Claim_id`) REFERENCES `claim_master` (`Claim_id`)
...
-- Dump completed on 2022-04-17 15:03:06
